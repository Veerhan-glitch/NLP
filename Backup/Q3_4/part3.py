# L=1 | ep=0 | loss=0.428 | F1=0.057 | EM=0.000
# L=1 | ep=1 | loss=0.238 | F1=0.056 | EM=0.000
# L=1 | ep=2 | loss=0.202 | F1=0.064 | EM=0.000
# L=1 | ep=3 | loss=0.165 | F1=0.077 | EM=0.001
# L=1 | ep=4 | loss=0.132 | F1=0.075 | EM=0.001
# L=1 | ep=5 | loss=0.106 | F1=0.079 | EM=0.001
# L=1 | ep=6 | loss=0.075 | F1=0.080 | EM=0.001
# L=1 | ep=7 | loss=0.061 | F1=0.088 | EM=0.001
# L=1 | ep=8 | loss=0.045 | F1=0.083 | EM=0.001
# L=1 | ep=9 | loss=0.041 | F1=0.081 | EM=0.001

# Training with L=2
# L=2 | ep=0 | loss=0.447 | F1=0.054 | EM=0.000
# L=2 | ep=1 | loss=0.235 | F1=0.058 | EM=0.000
# L=2 | ep=2 | loss=0.193 | F1=0.067 | EM=0.001
# L=2 | ep=3 | loss=0.158 | F1=0.075 | EM=0.001
# L=2 | ep=4 | loss=0.130 | F1=0.078 | EM=0.001
# L=2 | ep=5 | loss=0.101 | F1=0.074 | EM=0.000
# L=2 | ep=6 | loss=0.080 | F1=0.074 | EM=0.001
# L=2 | ep=7 | loss=0.062 | F1=0.079 | EM=0.001
# L=2 | ep=8 | loss=0.053 | F1=0.080 | EM=0.001
# L=2 | ep=9 | loss=0.048 | F1=0.084 | EM=0.001

# Training with L=3
# L=3 | ep=0 | loss=0.541 | F1=0.043 | EM=0.000
# L=3 | ep=1 | loss=0.244 | F1=0.064 | EM=0.000
# L=3 | ep=2 | loss=0.199 | F1=0.060 | EM=0.000
# L=3 | ep=3 | loss=0.160 | F1=0.069 | EM=0.001
# L=3 | ep=4 | loss=0.128 | F1=0.075 | EM=0.001
# L=3 | ep=5 | loss=0.107 | F1=0.077 | EM=0.001
# L=3 | ep=6 | loss=0.089 | F1=0.074 | EM=0.001
# L=3 | ep=7 | loss=0.065 | F1=0.081 | EM=0.001
# L=3 | ep=8 | loss=0.058 | F1=0.080 | EM=0.001
# L=3 | ep=9 | loss=0.050 | F1=0.082 | EM=0.001
...
# INFERENCE
# ============================================================
def run_inference_on_file(model, vocab, input_path, output_path="output.jsonl"):
    model.eval()
    results = []
