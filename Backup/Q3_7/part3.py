# L=1 | ep=0 | loss=0.486 | F1=0.076 | EM=0.000
# L=1 | ep=1 | loss=0.187 | F1=0.080 | EM=0.000
# L=1 | ep=2 | loss=0.129 | F1=0.075 | EM=0.001
# L=1 | ep=3 | loss=0.090 | F1=0.084 | EM=0.001
# L=1 | ep=4 | loss=0.062 | F1=0.084 | EM=0.001
# L=1 | ep=5 | loss=0.049 | F1=0.084 | EM=0.001
# L=1 | ep=6 | loss=0.039 | F1=0.086 | EM=0.001
# L=1 | ep=7 | loss=0.034 | F1=0.084 | EM=0.001
# L=1 | ep=8 | loss=0.027 | F1=0.086 | EM=0.001
# L=1 | ep=9 | loss=0.026 | F1=0.087 | EM=0.001

# Training with L=2
# L=2 | ep=0 | loss=0.501 | F1=0.059 | EM=0.000
# L=2 | ep=1 | loss=0.183 | F1=0.087 | EM=0.000
# L=2 | ep=2 | loss=0.122 | F1=0.085 | EM=0.001
# L=2 | ep=3 | loss=0.088 | F1=0.091 | EM=0.001
# L=2 | ep=4 | loss=0.065 | F1=0.088 | EM=0.001
# L=2 | ep=5 | loss=0.053 | F1=0.094 | EM=0.001
# L=2 | ep=6 | loss=0.043 | F1=0.097 | EM=0.001
# L=2 | ep=7 | loss=0.041 | F1=0.091 | EM=0.001
# L=2 | ep=8 | loss=0.034 | F1=0.089 | EM=0.001
# L=2 | ep=9 | loss=0.028 | F1=0.089 | EM=0.001
# Early stopping at epoch 9 for L=2

# Training with L=3
# L=3 | ep=0 | loss=0.566 | F1=0.085 | EM=0.000
# L=3 | ep=1 | loss=0.202 | F1=0.093 | EM=0.000
# L=3 | ep=2 | loss=0.132 | F1=0.082 | EM=0.001
# L=3 | ep=3 | loss=0.097 | F1=0.094 | EM=0.001
# L=3 | ep=4 | loss=0.073 | F1=0.087 | EM=0.001
# L=3 | ep=5 | loss=0.059 | F1=0.092 | EM=0.000
# L=3 | ep=6 | loss=0.045 | F1=0.096 | EM=0.000
# L=3 | ep=7 | loss=0.039 | F1=0.088 | EM=0.001
# L=3 | ep=8 | loss=0.031 | F1=0.100 | EM=0.001
# L=3 | ep=9 | loss=0.028 | F1=0.090 | EM=0.001
        ...
        for L in NUM_LAYERS_LIST:
            ...
            for ep in range(EPOCHS):
                ...
                if patience_counter >= patience:
                    print(f"Early stopping at epoch {ep} for L={L}")
                    break
