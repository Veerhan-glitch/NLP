# L=1 | ep=0 | loss=0.474 | F1=0.087 | EM=0.000
# L=1 | ep=1 | loss=0.186 | F1=0.086 | EM=0.000
# L=1 | ep=2 | loss=0.130 | F1=0.074 | EM=0.001
# L=1 | ep=3 | loss=0.087 | F1=0.088 | EM=0.001
# L=1 | ep=4 | loss=0.058 | F1=0.082 | EM=0.001
# L=1 | ep=5 | loss=0.045 | F1=0.086 | EM=0.001
# L=1 | ep=6 | loss=0.038 | F1=0.088 | EM=0.001
# L=1 | ep=7 | loss=0.029 | F1=0.084 | EM=0.001
# L=1 | ep=8 | loss=0.027 | F1=0.081 | EM=0.001
# L=1 | ep=9 | loss=0.026 | F1=0.088 | EM=0.001

# Training with L=2
# L=2 | ep=0 | loss=0.516 | F1=0.069 | EM=0.000
# L=2 | ep=1 | loss=0.190 | F1=0.084 | EM=0.000
# L=2 | ep=2 | loss=0.129 | F1=0.086 | EM=0.001
# L=2 | ep=3 | loss=0.089 | F1=0.087 | EM=0.000
# L=2 | ep=4 | loss=0.071 | F1=0.087 | EM=0.001
# L=2 | ep=5 | loss=0.051 | F1=0.085 | EM=0.001
# L=2 | ep=6 | loss=0.040 | F1=0.088 | EM=0.001
# L=2 | ep=7 | loss=0.035 | F1=0.089 | EM=0.001
# L=2 | ep=8 | loss=0.029 | F1=0.085 | EM=0.001
# L=2 | ep=9 | loss=0.029 | F1=0.089 | EM=0.001

# Training with L=3
# L=3 | ep=0 | loss=0.575 | F1=0.095 | EM=0.000
# L=3 | ep=1 | loss=0.213 | F1=0.092 | EM=0.000
# L=3 | ep=2 | loss=0.138 | F1=0.091 | EM=0.001
# L=3 | ep=3 | loss=0.099 | F1=0.094 | EM=0.000
# L=3 | ep=4 | loss=0.072 | F1=0.081 | EM=0.001
# L=3 | ep=5 | loss=0.056 | F1=0.087 | EM=0.000
# L=3 | ep=6 | loss=0.046 | F1=0.081 | EM=0.001
# L=3 | ep=7 | loss=0.043 | F1=0.085 | EM=0.001
# L=3 | ep=8 | loss=0.033 | F1=0.094 | EM=0.001
# L=3 | ep=9 | loss=0.033 | F1=0.086 | EM=0.001
